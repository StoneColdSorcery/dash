...
GPIO_TypeDef* DIG_GPIO_PORT[NDIGITS] = {DIG1_GPIO_PORT,DIG2_GPIO_PORT};

const uint32_t DIG_GPIO_PIN[NDIGITS] = {DIG1_GPIO_PIN,DIG2_GPIO_PIN};

const uint32_t DIG_GPIO_CLK[NDIGITS] = {DIG1_GPIO_CLK,DIG2_GPIO_CLK};

const uint16_t 7s_BCD[10] =
{
	0x3f, //0
	0x06, //1
	0x3b, //2
...
void GenerateDigits(uint32_t num,)
{
